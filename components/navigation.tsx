  ...
  >
    ...
    />
                ...
                <li key={item.id}>
                  <Link
                    ...
                    className={`
                      ...
                      ${item.isActive ? "after:bg-teal-600 after:w-4" : ""}
                    `}
                  >
                    {item.text}
                  </Link>
          ...
          <div className="flex items-center flex-1">
            <Link href="#" className="flex items-center gap-x-2 text-gray-800 dark:text-gray-200">
              <span className="bg-teal-600 text-white px-4 py-1.5 rounded-lg font-semibold">SM</span>
              <span aria-hidden="true" className="hidden sm:flex font-semibold">
                Serene Minds
              </span>
            </Link>
          </div>
          <div className="flex justify-end items-center gap-x-4 w-full text-gray-700 dark:text-gray-300">
            <a
              href="tel:+14076937055"
              className="duration-200 ease-linear hover:text-teal-600 dark:hover:text-teal-400 flex items-center gap-x-1"
              rel="noreferer"
            >
            ...
            <a
              href="#"
              target="_blank"
              className="duration-200 ease-linear hover:text-teal-600 dark:hover:text-teal-400"
